...
// string myarr = "((0  0,  0 10,  10 10,  10 0,  0  0))((12 3, 12 30, 32 30, 32 3, 12 3))((30 0, 30 5, 40 5, 40 0, 30 0))((0 40, 0 50, 6 50, 6 40, 0 40))((30 42, 30 50, 40 50, 40 42, 30 42)) ";
int num_layers, num_polys, num_rects, num_texts;

int main()
{
  // string *ptr;    // pointer to hold address
  // ptr = parser(); // address of returned array
  // getMaxUnion(ptr);
  auto [arr_polys, arr_rects] = parser();
  // getMaxUnion(arr_polys);
...
tuple<multi_polygon, box> getMaxUnion(const string *arr)
{
  ...
  // int arr_polys[3];
  // for (const int &str : arr_polys)
  // {
  //   cout << str << "\t"; // ptr[i] is equivalent to *(ptr+i)
  // }
  // BOOST_FOREACH (string const &str, arr) // output is an array because it may contain more than one area like "differences"
  // {
  //   cout << str << "\t"; // ptr[i] is equivalent to *(ptr+i)
  // }
...
tuple<string *, string *> parser() // return type: address of string array
{
  ...
  // {
  //   cout << "layer " << i << " M" << i << endl;
  // }
  // cout << "end_of_layer" << endl;
  ...
  // {
  //   cout << "arr_polygons " << arr_polys[i] << endl;
  // }
  //////
