...
#include "../object_viewer2/canvas.h"
...
Q_CONSTINIT static const qt_meta_stringdata_CLASSCanvasENDCLASS_t qt_meta_stringdata_CLASSCanvasENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(7, 11),  // "ButtonPress"
        QT_MOC_LITERAL(19, 0),  // ""
        QT_MOC_LITERAL(20, 13)   // "EnterKeyPress"
    },
    "Canvas",
    "ButtonPress",
    "",
...
void Canvas::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &Canvas::ButtonPress; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Canvas::*)();
            if (_t _q_method = &Canvas::EnterKeyPress; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Canvas::ButtonPress()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void Canvas::EnterKeyPress()
{
